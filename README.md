    ...
    <section id="gallery" class="py-28 px-6 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="group bg-cardBg rounded-sm overflow-hidden border border-slate-800/60 hover:border-accentGold/50 transition duration-300">
                <div class="aspect-square overflow-hidden bg-slate-900 relative flex items-center justify-center">
                    <img src="LINE_NOTE_260803_1.jpg" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500" alt="Ether Matrix">
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-2">
                        ...
                        <span class="text-accentGold font-mono text-sm px-1 rounded transition">€ 1,200</span>
                    </div>
            ...
            <div class="group bg-cardBg rounded-sm overflow-hidden border border-slate-800/60 hover:border-accentGold/50 transition duration-300">
                <div class="aspect-square overflow-hidden bg-slate-900 relative flex items-center justify-center">
                    <img src="LINE_NOTE_260803_2.jpg" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500" alt="Cosmic Heart">
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-2">
                        ...
                        <span class="text-accentGold font-mono text-sm px-1 rounded transition">€ 280</span>
                    </div>
            ...
            <div class="group bg-cardBg rounded-sm overflow-hidden border border-slate-800/60 hover:border-accentGold/50 transition duration-300">
                <div class="aspect-square overflow-hidden bg-slate-900 relative flex items-center justify-center">
                    <img src="LINE_NOTE_260803_4.jpg" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition duration-500" alt="Silent Zero">
                    <span class="absolute top-4 left-4 bg-darkBg/80 text-xs px-3 py-1 text-accentGold tracking-wider uppercase border border-slate-700 z-10">Original</span>
                </div>
                <div class="p-6">
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="text-lg font-light tracking-wide">Silent Zero (Absolute Stille)</h3>
                        <span class="text-accentGold font-mono text-sm px-1 rounded transition">€ 1,500</span>
                    </div>
    ...
    <section id="about" class="py-28 bg-cardBg/40 border-y border-slate-800/80 px-6 transition">
        <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
            ...
            <div class="flex flex-col space-y-3">
                <div class="aspect-[3/4] bg-slate-800 border border-slate-700 relative flex items-center justify-center overflow-hidden">
                    <img src="LINE_ALBUM_讓我依依不捨的妳_260723_17.jpg" class="absolute inset-0 w-full h-full object-cover" alt="Künstlerporträt">
                </div>
            </div>

            <div class="md:col-span-2">
                <span class="text-accentGold tracking-[0.3em] uppercase text-xs block mb-3">Biografie</span>
                <h2 class="text-2xl font-light tracking-wide mb-6">Im rationalen Raum Deutschlands die heilige Geometrie des Ostens weben</h2>
                <p class="text-slate-300 font-light text-sm leading-relaxed mb-4">Lebt in Deutschland. Der Kern der Arbeit entspringt der Suche nach der zugrunde liegenden Struktur des Lebens. Mandala bedeutet im Sanskrit „Kreis“ und ist auch ein Dialog zwischen dem Mikrokosmos und dem makrokosmischen Geist.</p>
                <p class="text-slate-400 font-light text-sm leading-relaxed mb-6">Durch extrem strenge geometrische Symmetrie und feine Pinselstriche werden Energiefelder auf der Leinwand aufgebaut, die den Betrachter zu innerem Frieden führen können. Die Werke wurden in unabhängigen Galerien in Berlin, Frankfurt und anderen Orten ausgestellt.</p>
                <div class="text-xs text-accentGold tracking-wider">Ausstellungen: Berlin Art Week (2025) • München Design Center (2024)</div>
            </div>
        </div>
    </section>
